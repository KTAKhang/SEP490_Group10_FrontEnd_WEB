 ...
 * Trang riêng quản lý đơn REFUND - action "Xác nhận đã hoàn tiền"
 * Phân biệt với Update order status thông thường.
 */
    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          ...
          Quản lý đơn hoàn tiền
        </h1>
        <p className="mt-1 text-sm text-gray-600">
          Các đơn có trạng thái REFUND — Xác nhận đã hoàn tiền khi đã xử lý xong. (Action riêng, không dùng Update order status)
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        {adminLoading ? (
          <div className="py-16 text-center text-gray-500">
            Đang tải danh sách đơn REFUND...
          </div>
        ) : orders.length === 0 ? (
          <div className="py-16 text-center text-gray-500">
            Không có đơn nào ở trạng thái REFUND.
          </div>
        ) : (
          <>
